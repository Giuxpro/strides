...
export default function SignupPage() {
  return (
    <div
      className={`${nunito.variable} relative min-h-screen flex items-center justify-center p-6 overflow-hidden`}
      style={{
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        >
          ...
          <h2
            ...
            style={{ fontSize: 22, color: '#1E1B4B', fontFamily: 'var(--font-nunito)' }}
          >
            ¡Crea tu cuenta! ✨
          </h2>
