...
export function SpeakQuestion({ item, moduleConfig, onAnswer }: EvalFormatProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-4 w-full">
      ...
      <p className="font-bold capitalize text-center" style={{ color: 'var(--kids-text)' }}>{expected}</p>
      ...
      <div className="w-32 h-1.5 rounded-full overflow-hidden" style={{ background: 'var(--kids-border-color)' }}>
