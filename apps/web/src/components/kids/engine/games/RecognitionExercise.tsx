          ...
          {options.map(option => {
            ...
            return (
              <button
                ...
                className="rounded-2xl p-3 flex flex-col items-center justify-center gap-1.5 transition-all duration-150 active:scale-95 hover:scale-[1.03]"
              ...
              >
                {option.image_url ? (
                  ...
                  <span className="text-3xl select-none">{option.text_en[0]?.toUpperCase()}</span>
                )}
                <span
                ...
                <span
                  className="text-[10px] text-center leading-tight opacity-50"
                  style={{ color: 'var(--kids-text)' }}
                >
                  {option.text_es}
                </span>
