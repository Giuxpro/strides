-- Add search + pagination to get_admin_users_overview.
-- The old function had no params; we drop it and replace with a paginated version.
-- get_admin_users_count provides the total for pagination controls.
