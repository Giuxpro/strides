-- Drop all existing versions regardless of signature, then create final clean version.
...
DROP FUNCTION IF EXISTS public.get_admin_users_count();
...
-- Backfill: mark already-expired trials correctly in the DB (source of truth)
...
-- pg_cron: keep trial statuses in sync every hour
